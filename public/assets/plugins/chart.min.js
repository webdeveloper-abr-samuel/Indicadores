...
!(function(t, e) {
  ...
  class Ri {
    ...
    buildOrUpdateElements(t) {
      ...
      (i._stacked = Si(i.vScale, i)),
        i.stack !== n.stack && ((o = !0), Ti(i), (i.stack = n.stack)),
        e._resyncElements(t),
  ...
  class Xi extends Ei {
    ...
    drawTitle() {
      ...
      "bottom" === e
        ...
        : (l += a.top);
      const { titleX: c, titleY: h, maxWidth: d, rotation: u } = (function(
        t,
        e,
        i,
        n
  ...
  function Mn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      ...
      { start: h, end: d, loop: u, style: f } = (function(t, e, i) {
        const { property: n, start: o, end: s } = i,
  ...
  var An = new (class {
    constructor() {
      (this.controllers = new Tn(Ri, "datasets", !0)),
        (this.elements = new Tn(Ei, "elements")),
        (this.plugins = new Tn(Object, "plugins")),
        (this.scales = new Tn(Xi, "scales")),
  ...
  Object.defineProperties(to, {
    ...
    registry: { enumerable: io, value: An },
    version: { enumerable: io, value: "3.3.2" },
  ...
  class ho extends Ri {
    ...
    _getStacks(t, e) {
      ...
      for (r = 0; r < s; ++r) {
        if (((l = n[r]), void 0 !== e)) {
          const t = l.controller.getParsed(e)[
  ...
  function Mo(t, e, i, n) {
    const { x: o, y: s, startAngle: a, pixelMargin: r, innerRadius: l } = e,
      ...
      f = a + u,
      g = n - u,
      { outerStart: p, outerEnd: m, innerStart: x, innerEnd: b } = vo(
        e,
        h,
        c,
        g - f
  ...
  function Fo(t, e) {
    const { x: i, y: n, base: o, width: s, height: a } = t.getProps(
      ...
      const o = (function(t, e) {
        ...
        for (
          ...
          (d && v !== s
            ? (i.push({ value: s }),
              v < s && P++,
              At(Math.round((v + P * k) * y) / y, s, Es(s, _, t)) && P++)
            : v < s && P++);
          P < M;
          ++P
        )
        ...
        return (
          x && d && w !== a
            ? At(i[i.length - 1].value, a, Es(a, _, t))
  ...
  return (
    to.register(_o, ia, Uo, As),
    (to.helpers = { ...On }),
    (to._adapters = so),
    (to.Animation = _i),
    (to.Animations = vi),
    (to.animator = a),
    (to.controllers = An.controllers.items),
    ...
    (to.Scale = Xi),
    (to.Ticks = Vi),
    Object.assign(to, _o, ia, Uo, As, ui),
    (to.Chart = to),
